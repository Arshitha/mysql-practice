...
--#2
/*Checking a list The word IN allows us to check if an item is
 in a list. The example shows the name and population for the 
...
Modify it to show the country and the area for countries with an 
